      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <Link to="/" className="flex items-center">
              <h1 className="text-xl font-bold font-serif text-primary">Vibrant<span className="text-secondary">Vista</span></h1>
            </Link>
            <p className="mt-4 text-muted-foreground">
              Explore diverse perspectives, share your stories, and connect with a vibrant community of writers and readers.
            </p>
          </div>
        ...
        <div className="mt-12 border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            &copy; {currentYear} VibrantVista. All rights reserved.
          </p>
