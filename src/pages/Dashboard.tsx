      ...
      <main className="flex-grow py-12">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            <h1 className="text-2xl md:text-3xl font-bold font-serif">Your Dashboard</h1>
            <Link to="/create-post">
          ...
          {isLoading ? (
            <div className="space-y-6">
              {[1, 2, 3].map((i) => (
                <div key={i} className="animate-pulse bg-white rounded-xl p-6 h-24 border border-border"></div>
              ))}
            </div>
          ) : posts.length > 0 ? (
            <div className="space-y-4">
              {posts.map((post) => (
                <div key={post._id} className="bg-white p-4 sm:p-6 rounded-xl border border-border flex flex-col sm:flex-row gap-4 sm:gap-6 items-start sm:items-center">
                  ...
                  <div className="flex gap-2 w-full sm:w-auto">
                    <Link to={`/edit-post/${post._id}`} className="w-full sm:w-auto">
            ...
            <div className="bg-muted/30 rounded-xl p-12 text-center">
              <h3 className="text-lg font-medium mb-2">You haven't written any posts yet</h3>
              <p className="text-muted-foreground mb-6">Create your first post to share your thoughts with the world.</p>
              <Link to="/create-post">
                <Button>
